...
var taskInput=document.getElementById("new-task__inp");//Add a new task.
...
var createNewTaskElement=function(taskString){
  ...
  editInput.type="text";
  editInput.className="item__inp-text";

  editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
  editButton.className="item__btn-edit";

  deleteButton.className="item__btn-delete";
...
var addTask=function(){
  ...
  //Create a new list item with the text from the #new-task__inp:
...
var bindTaskEvents=function(taskListItem,checkBoxEventHandler){
  ...
  var editButton=taskListItem.querySelector("button.item__btn-edit");
  var deleteButton=taskListItem.querySelector("button.item__btn-delete");
